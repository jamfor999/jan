...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      ...
      className={cn(
        'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-main-view-fg/20 disabled:pointer-events-none disabled:opacity-50 bg-main-view-fg text-main-view px-4 py-2',
        className
      )}
      {...props}
    />
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      ...
      className={cn(
        'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md border border-main-view-fg/20 bg-main-view text-main-view-fg px-4 py-2 text-sm font-medium transition-colors hover:bg-main-view-fg/5 disabled:pointer-events-none disabled:opacity-50',
        className
      )}
      {...props}
    />
